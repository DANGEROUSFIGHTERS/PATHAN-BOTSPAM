...
BOT_IS_UP_TO_DATE = "**The DANGEROUS FIGHTERS  Robot Spam Bot** is up-to-date sur."
...
async def restart(e):
    if e.sender_id == OWNER_ID:
        text = "__U𝗽𝗱𝗮𝘁𝗶𝗻𝗴..... 𝗗𝗔𝗡𝗚𝗘𝗥𝗢𝗨𝗦 𝗙𝗜𝗚𝗛𝗧𝗘𝗥𝗦 𝗕𝗢𝗧𝗦𝗣𝗔𝗠 𝗧𝗔𝗬𝗬𝗔𝗥 𝗛𝗔𝗜__\n𝗧𝘆𝗽𝗲 .ping 𝗔𝗳𝘁𝗲𝗿 5𝗺𝗶𝗻𝘀 𝗧𝗼 𝗖𝗵𝗲𝗰𝗸 𝗜'𝗺 𝗼𝗻 !!"
...
async def deploy_start(SAM, message, refspec, remote):
    ...
    await message.edit(
        "Updated Your Dangerous Fighters Robot Spam Bot successfully sur!!!\n© @MR_STONEDLEGEND"
    )
